...
public class CustomCheckBox : CheckBox
{
    ...
    private static readonly SolidColorBrush CheckedBrush = new SolidColorBrush(
        Color.FromArgb(0xFF, 0xF3, 0xB5, 0x5C)
    );
    private static readonly SolidColorBrush UncheckedBackground = new SolidColorBrush(
        Color.FromArgb(0x80, 0xF5, 0xED, 0xE4)
    );
    private static readonly SolidColorBrush UncheckedBorder = new SolidColorBrush(
        Color.FromArgb(0xFF, 0xE8, 0xDD, 0xD4)
    );
    private static readonly SolidColorBrush PointerOverBorder = new SolidColorBrush(
        Color.FromArgb(0xFF, 0xF3, 0xB5, 0x5C)
    );
