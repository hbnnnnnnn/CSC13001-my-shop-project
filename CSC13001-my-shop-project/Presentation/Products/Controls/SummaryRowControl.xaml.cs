...
public sealed partial class SummaryRowControl : UserControl
{
    ...
    public static readonly DependencyProperty ShowBottomDividerProperty = DependencyProperty.Register(
        ...
        typeof(bool),
        typeof(SummaryRowControl),
        new PropertyMetadata(true, OnShowBottomDividerChanged)
    );
    ...
    private static void OnShowBottomDividerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) =>
        ((SummaryRowControl)d).UpdateDivider();

    private void UpdateDivider()
    {
        BottomRule.Visibility = ShowBottomDivider ? Visibility.Visible : Visibility.Collapsed;
    }
}
